...
module TranslationUnit : sig
    val parse : index -> string -> string list -> unsaved_file list -> flags:translation_unit_flags -> translation_unit option
...
val with_translation_unit : string -> string list -> (translation_unit -> 'a) -> index -> 'a
