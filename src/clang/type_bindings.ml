...
module Types (T : TYPE) = struct
  ...
  module CXAvailabilityKind = struct
    ...
    let t : t typ = enum "CXAvailabilityKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXCursor_ExceptionSpecificationKind = struct
    ...
    let mapping = [
      CXCursor_ExceptionSpecificationKind_None, constant "CXCursor_ExceptionSpecificationKind_None" int64_t;
      CXCursor_ExceptionSpecificationKind_DynamicNone, constant "CXCursor_ExceptionSpecificationKind_DynamicNone" int64_t;
      CXCursor_ExceptionSpecificationKind_Dynamic, constant "CXCursor_ExceptionSpecificationKind_Dynamic" int64_t;
      CXCursor_ExceptionSpecificationKind_MSAny, constant "CXCursor_ExceptionSpecificationKind_MSAny" int64_t;
      CXCursor_ExceptionSpecificationKind_BasicNoexcept, constant "CXCursor_ExceptionSpecificationKind_BasicNoexcept" int64_t;
      CXCursor_ExceptionSpecificationKind_ComputedNoexcept, constant "CXCursor_ExceptionSpecificationKind_ComputedNoexcept" int64_t;
      CXCursor_ExceptionSpecificationKind_Unevaluated, constant "CXCursor_ExceptionSpecificationKind_Unevaluated" int64_t;
      CXCursor_ExceptionSpecificationKind_Uninstantiated, constant "CXCursor_ExceptionSpecificationKind_Uninstantiated" int64_t;
      CXCursor_ExceptionSpecificationKind_Unparsed, constant "CXCursor_ExceptionSpecificationKind_Unparsed" int64_t;
      CXCursor_ExceptionSpecificationKind_NoThrow, constant "CXCursor_ExceptionSpecificationKind_NoThrow" int64_t;
    ]
    let t : t typ = enum "CXCursor_ExceptionSpecificationKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXChoice = struct
    ...
    let t : t typ = enum "CXChoice" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXGlobalOptFlags = struct
    ...
    let mapping = [
      ...
      CXGlobalOpt_ThreadBackgroundPriorityForIndexing, constant "CXGlobalOpt_ThreadBackgroundPriorityForIndexing" int64_t;
      CXGlobalOpt_ThreadBackgroundPriorityForEditing, constant "CXGlobalOpt_ThreadBackgroundPriorityForEditing" int64_t;
      CXGlobalOpt_ThreadBackgroundPriorityForAll, constant "CXGlobalOpt_ThreadBackgroundPriorityForAll" int64_t;
    ]
    let t : t typ = enum "CXGlobalOptFlags" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIndexOptions = struct
    ...
    let thread_background_priority_for_indexing = field t "ThreadBackgroundPriorityForIndexing" uchar
    let thread_background_priority_for_editing = field t "ThreadBackgroundPriorityForEditing" uchar
  ...
  module CXTranslationUnit_Flags = struct
    ...
    let mapping = [
      ...
      CXTranslationUnit_DetailedPreprocessingRecord, constant "CXTranslationUnit_DetailedPreprocessingRecord" int64_t;
      CXTranslationUnit_Incomplete, constant "CXTranslationUnit_Incomplete" int64_t;
      CXTranslationUnit_PrecompiledPreamble, constant "CXTranslationUnit_PrecompiledPreamble" int64_t;
      CXTranslationUnit_CacheCompletionResults, constant "CXTranslationUnit_CacheCompletionResults" int64_t;
      CXTranslationUnit_ForSerialization, constant "CXTranslationUnit_ForSerialization" int64_t;
      CXTranslationUnit_CXXChainedPCH, constant "CXTranslationUnit_CXXChainedPCH" int64_t;
      CXTranslationUnit_SkipFunctionBodies, constant "CXTranslationUnit_SkipFunctionBodies" int64_t;
      CXTranslationUnit_IncludeBriefCommentsInCodeCompletion, constant "CXTranslationUnit_IncludeBriefCommentsInCodeCompletion" int64_t;
      CXTranslationUnit_CreatePreambleOnFirstParse, constant "CXTranslationUnit_CreatePreambleOnFirstParse" int64_t;
      CXTranslationUnit_KeepGoing, constant "CXTranslationUnit_KeepGoing" int64_t;
      CXTranslationUnit_SingleFileParse, constant "CXTranslationUnit_SingleFileParse" int64_t;
      CXTranslationUnit_LimitSkipFunctionBodiesToPreamble, constant "CXTranslationUnit_LimitSkipFunctionBodiesToPreamble" int64_t;
      CXTranslationUnit_IncludeAttributedTypes, constant "CXTranslationUnit_IncludeAttributedTypes" int64_t;
      CXTranslationUnit_VisitImplicitAttributes, constant "CXTranslationUnit_VisitImplicitAttributes" int64_t;
      CXTranslationUnit_IgnoreNonErrorsFromIncludedFiles, constant "CXTranslationUnit_IgnoreNonErrorsFromIncludedFiles" int64_t;
      CXTranslationUnit_RetainExcludedConditionalBlocks, constant "CXTranslationUnit_RetainExcludedConditionalBlocks" int64_t;
    ]
    let t : t typ = enum "CXTranslationUnit_Flags" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXSaveTranslationUnit_Flags = struct
    ...
    let t : t typ = enum "CXSaveTranslationUnit_Flags" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXSaveError = struct
    ...
    let t : t typ = enum "CXSaveError" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXReparse_Flags = struct
    type t =
      | CXReparse_None
    let mapping = [
      CXReparse_None, constant "CXReparse_None" int64_t;
    ]
    let t : t typ = enum "CXReparse_Flags" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTUResourceUsageKind = struct
    ...
    let mapping = [
      ...
      CXTUResourceUsage_GlobalCompletionResults, constant "CXTUResourceUsage_GlobalCompletionResults" int64_t;
      CXTUResourceUsage_SourceManagerContentCache, constant "CXTUResourceUsage_SourceManagerContentCache" int64_t;
      CXTUResourceUsage_AST_SideTables, constant "CXTUResourceUsage_AST_SideTables" int64_t;
      CXTUResourceUsage_SourceManager_Membuffer_Malloc, constant "CXTUResourceUsage_SourceManager_Membuffer_Malloc" int64_t;
      CXTUResourceUsage_SourceManager_Membuffer_MMap, constant "CXTUResourceUsage_SourceManager_Membuffer_MMap" int64_t;
      CXTUResourceUsage_ExternalASTSource_Membuffer_Malloc, constant "CXTUResourceUsage_ExternalASTSource_Membuffer_Malloc" int64_t;
      CXTUResourceUsage_ExternalASTSource_Membuffer_MMap, constant "CXTUResourceUsage_ExternalASTSource_Membuffer_MMap" int64_t;
      CXTUResourceUsage_Preprocessor, constant "CXTUResourceUsage_Preprocessor" int64_t;
      CXTUResourceUsage_PreprocessingRecord, constant "CXTUResourceUsage_PreprocessingRecord" int64_t;
      CXTUResourceUsage_SourceManager_DataStructures, constant "CXTUResourceUsage_SourceManager_DataStructures" int64_t;
      CXTUResourceUsage_Preprocessor_HeaderSearch, constant "CXTUResourceUsage_Preprocessor_HeaderSearch" int64_t;
      CXTUResourceUsage_MEMORY_IN_BYTES_BEGIN, constant "CXTUResourceUsage_MEMORY_IN_BYTES_BEGIN" int64_t;
      CXTUResourceUsage_MEMORY_IN_BYTES_END, constant "CXTUResourceUsage_MEMORY_IN_BYTES_END" int64_t;
    ...
    let t : t typ = enum "CXTUResourceUsageKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end

  module CXTUResourceUsageEntry = struct
    type t
    let t : t structure typ = typedef (structure "CXTUResourceUsageEntry") "CXTUResourceUsageEntry"
  ...
  module CXCursorKind = struct
    ...
    let mapping = [
      ...
      CXCursor_ObjCInstanceMethodDecl, constant "CXCursor_ObjCInstanceMethodDecl" int64_t;
      CXCursor_ObjCClassMethodDecl, constant "CXCursor_ObjCClassMethodDecl" int64_t;
      CXCursor_ObjCImplementationDecl, constant "CXCursor_ObjCImplementationDecl" int64_t;
      ...
      CXCursor_NonTypeTemplateParameter, constant "CXCursor_NonTypeTemplateParameter" int64_t;
      CXCursor_TemplateTemplateParameter, constant "CXCursor_TemplateTemplateParameter" int64_t;
      ...
      CXCursor_ClassTemplatePartialSpecialization, constant "CXCursor_ClassTemplatePartialSpecialization" int64_t;
      ...
      CXCursor_CompoundAssignOperator, constant "CXCursor_CompoundAssignOperator" int64_t;
      ...
      CXCursor_CXXReinterpretCastExpr, constant "CXCursor_CXXReinterpretCastExpr" int64_t;
      ...
      CXCursor_ObjCAvailabilityCheckExpr, constant "CXCursor_ObjCAvailabilityCheckExpr" int64_t;
      ...
      CXCursor_ConceptSpecializationExpr, constant "CXCursor_ConceptSpecializationExpr" int64_t;
      ...
      CXCursor_ObjCAtSynchronizedStmt, constant "CXCursor_ObjCAtSynchronizedStmt" int64_t;
      CXCursor_ObjCAutoreleasePoolStmt, constant "CXCursor_ObjCAutoreleasePoolStmt" int64_t;
      ...
      CXCursor_OMPParallelForDirective, constant "CXCursor_OMPParallelForDirective" int64_t;
      CXCursor_OMPParallelSectionsDirective, constant "CXCursor_OMPParallelSectionsDirective" int64_t;
      ...
      CXCursor_OMPParallelForSimdDirective, constant "CXCursor_OMPParallelForSimdDirective" int64_t;
      ...
      CXCursor_OMPCancellationPointDirective, constant "CXCursor_OMPCancellationPointDirective" int64_t;
      CXCursor_OMPCancelDirective, constant "CXCursor_OMPCancelDirective" int64_t;
      CXCursor_OMPTargetDataDirective, constant "CXCursor_OMPTargetDataDirective" int64_t;
      CXCursor_OMPTaskLoopDirective, constant "CXCursor_OMPTaskLoopDirective" int64_t;
      CXCursor_OMPTaskLoopSimdDirective, constant "CXCursor_OMPTaskLoopSimdDirective" int64_t;
      CXCursor_OMPDistributeDirective, constant "CXCursor_OMPDistributeDirective" int64_t;
      CXCursor_OMPTargetEnterDataDirective, constant "CXCursor_OMPTargetEnterDataDirective" int64_t;
      CXCursor_OMPTargetExitDataDirective, constant "CXCursor_OMPTargetExitDataDirective" int64_t;
      CXCursor_OMPTargetParallelDirective, constant "CXCursor_OMPTargetParallelDirective" int64_t;
      CXCursor_OMPTargetParallelForDirective, constant "CXCursor_OMPTargetParallelForDirective" int64_t;
      CXCursor_OMPTargetUpdateDirective, constant "CXCursor_OMPTargetUpdateDirective" int64_t;
      CXCursor_OMPDistributeParallelForDirective, constant "CXCursor_OMPDistributeParallelForDirective" int64_t;
      CXCursor_OMPDistributeParallelForSimdDirective, constant "CXCursor_OMPDistributeParallelForSimdDirective" int64_t;
      CXCursor_OMPDistributeSimdDirective, constant "CXCursor_OMPDistributeSimdDirective" int64_t;
      CXCursor_OMPTargetParallelForSimdDirective, constant "CXCursor_OMPTargetParallelForSimdDirective" int64_t;
      CXCursor_OMPTargetSimdDirective, constant "CXCursor_OMPTargetSimdDirective" int64_t;
      CXCursor_OMPTeamsDistributeDirective, constant "CXCursor_OMPTeamsDistributeDirective" int64_t;
      CXCursor_OMPTeamsDistributeSimdDirective, constant "CXCursor_OMPTeamsDistributeSimdDirective" int64_t;
      CXCursor_OMPTeamsDistributeParallelForSimdDirective, constant "CXCursor_OMPTeamsDistributeParallelForSimdDirective" int64_t;
      CXCursor_OMPTeamsDistributeParallelForDirective, constant "CXCursor_OMPTeamsDistributeParallelForDirective" int64_t;
      CXCursor_OMPTargetTeamsDirective, constant "CXCursor_OMPTargetTeamsDirective" int64_t;
      CXCursor_OMPTargetTeamsDistributeDirective, constant "CXCursor_OMPTargetTeamsDistributeDirective" int64_t;
      CXCursor_OMPTargetTeamsDistributeParallelForDirective, constant "CXCursor_OMPTargetTeamsDistributeParallelForDirective" int64_t;
      CXCursor_OMPTargetTeamsDistributeParallelForSimdDirective, constant "CXCursor_OMPTargetTeamsDistributeParallelForSimdDirective" int64_t;
      CXCursor_OMPTargetTeamsDistributeSimdDirective, constant "CXCursor_OMPTargetTeamsDistributeSimdDirective" int64_t;
      CXCursor_BuiltinBitCastExpr, constant "CXCursor_BuiltinBitCastExpr" int64_t;
      CXCursor_OMPMasterTaskLoopDirective, constant "CXCursor_OMPMasterTaskLoopDirective" int64_t;
      CXCursor_OMPParallelMasterTaskLoopDirective, constant "CXCursor_OMPParallelMasterTaskLoopDirective" int64_t;
      CXCursor_OMPMasterTaskLoopSimdDirective, constant "CXCursor_OMPMasterTaskLoopSimdDirective" int64_t;
      CXCursor_OMPParallelMasterTaskLoopSimdDirective, constant "CXCursor_OMPParallelMasterTaskLoopSimdDirective" int64_t;
      CXCursor_OMPParallelMasterDirective, constant "CXCursor_OMPParallelMasterDirective" int64_t;
      ...
      CXCursor_OMPGenericLoopDirective, constant "CXCursor_OMPGenericLoopDirective" int64_t;
      CXCursor_OMPTeamsGenericLoopDirective, constant "CXCursor_OMPTeamsGenericLoopDirective" int64_t;
      CXCursor_OMPTargetTeamsGenericLoopDirective, constant "CXCursor_OMPTargetTeamsGenericLoopDirective" int64_t;
      CXCursor_OMPParallelGenericLoopDirective, constant "CXCursor_OMPParallelGenericLoopDirective" int64_t;
      CXCursor_OMPTargetParallelGenericLoopDirective, constant "CXCursor_OMPTargetParallelGenericLoopDirective" int64_t;
      CXCursor_OMPParallelMaskedDirective, constant "CXCursor_OMPParallelMaskedDirective" int64_t;
      CXCursor_OMPMaskedTaskLoopDirective, constant "CXCursor_OMPMaskedTaskLoopDirective" int64_t;
      CXCursor_OMPMaskedTaskLoopSimdDirective, constant "CXCursor_OMPMaskedTaskLoopSimdDirective" int64_t;
      CXCursor_OMPParallelMaskedTaskLoopDirective, constant "CXCursor_OMPParallelMaskedTaskLoopDirective" int64_t;
      CXCursor_OMPParallelMaskedTaskLoopSimdDirective, constant "CXCursor_OMPParallelMaskedTaskLoopSimdDirective" int64_t;
      ...
      CXCursor_OMPInterchangeDirective, constant "CXCursor_OMPInterchangeDirective" int64_t;
      CXCursor_OpenACCComputeConstruct, constant "CXCursor_OpenACCComputeConstruct" int64_t;
      ...
      CXCursor_IBOutletCollectionAttr, constant "CXCursor_IBOutletCollectionAttr" int64_t;
      ...
      CXCursor_ObjCReturnsInnerPointer, constant "CXCursor_ObjCReturnsInnerPointer" int64_t;
      ...
      CXCursor_ObjCSubclassingRestricted, constant "CXCursor_ObjCSubclassingRestricted" int64_t;
      CXCursor_ObjCExplicitProtocolImpl, constant "CXCursor_ObjCExplicitProtocolImpl" int64_t;
      CXCursor_ObjCDesignatedInitializer, constant "CXCursor_ObjCDesignatedInitializer" int64_t;
      ...
      CXCursor_PreprocessingDirective, constant "CXCursor_PreprocessingDirective" int64_t;
    ...
    let t : t typ = enum "CXCursorKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXLinkageKind = struct
    ...
    let t : t typ = enum "CXLinkageKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXVisibilityKind = struct
    ...
    let t : t typ = enum "CXVisibilityKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXPlatformAvailability = struct
    type t
    let t : t structure typ = typedef (structure "CXPlatformAvailability") "CXPlatformAvailability"
  ...
  module CXLanguageKind = struct
    ...
    let t : t typ = enum "CXLanguageKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTLSKind = struct
    ...
    let t : t typ = enum "CXTLSKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTypeKind = struct
    ...
    let mapping = [
      ...
      CXType_OCLImage2dArrayMSAADepthRO, constant "CXType_OCLImage2dArrayMSAADepthRO" int64_t;
      ...
      CXType_OCLImage2dArrayMSAADepthWO, constant "CXType_OCLImage2dArrayMSAADepthWO" int64_t;
      ...
      CXType_OCLImage2dArrayMSAADepthRW, constant "CXType_OCLImage2dArrayMSAADepthRW" int64_t;
      ...
      CXType_OCLIntelSubgroupAVCMcePayload, constant "CXType_OCLIntelSubgroupAVCMcePayload" int64_t;
      CXType_OCLIntelSubgroupAVCImePayload, constant "CXType_OCLIntelSubgroupAVCImePayload" int64_t;
      CXType_OCLIntelSubgroupAVCRefPayload, constant "CXType_OCLIntelSubgroupAVCRefPayload" int64_t;
      CXType_OCLIntelSubgroupAVCSicPayload, constant "CXType_OCLIntelSubgroupAVCSicPayload" int64_t;
      CXType_OCLIntelSubgroupAVCMceResult, constant "CXType_OCLIntelSubgroupAVCMceResult" int64_t;
      CXType_OCLIntelSubgroupAVCImeResult, constant "CXType_OCLIntelSubgroupAVCImeResult" int64_t;
      CXType_OCLIntelSubgroupAVCRefResult, constant "CXType_OCLIntelSubgroupAVCRefResult" int64_t;
      CXType_OCLIntelSubgroupAVCSicResult, constant "CXType_OCLIntelSubgroupAVCSicResult" int64_t;
      CXType_OCLIntelSubgroupAVCImeResultSingleReferenceStreamout, constant "CXType_OCLIntelSubgroupAVCImeResultSingleReferenceStreamout" int64_t;
      CXType_OCLIntelSubgroupAVCImeResultDualReferenceStreamout, constant "CXType_OCLIntelSubgroupAVCImeResultDualReferenceStreamout" int64_t;
      CXType_OCLIntelSubgroupAVCImeSingleReferenceStreamin, constant "CXType_OCLIntelSubgroupAVCImeSingleReferenceStreamin" int64_t;
      CXType_OCLIntelSubgroupAVCImeDualReferenceStreamin, constant "CXType_OCLIntelSubgroupAVCImeDualReferenceStreamin" int64_t;
      CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout, constant "CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout" int64_t;
      CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout, constant "CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout" int64_t;
      CXType_OCLIntelSubgroupAVCImeSingleRefStreamin, constant "CXType_OCLIntelSubgroupAVCImeSingleRefStreamin" int64_t;
      CXType_OCLIntelSubgroupAVCImeDualRefStreamin, constant "CXType_OCLIntelSubgroupAVCImeDualRefStreamin" int64_t;
    ...
    let t : t typ = enum "CXTypeKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXCallingConv = struct
    ...
    let mapping = [
      ...
      CXCallingConv_AArch64VectorCall, constant "CXCallingConv_AArch64VectorCall" int64_t;
    ...
    let t : t typ = enum "CXCallingConv" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTemplateArgumentKind = struct
    ...
    let mapping = [
      ...
      CXTemplateArgumentKind_Declaration, constant "CXTemplateArgumentKind_Declaration" int64_t;
      CXTemplateArgumentKind_NullPtr, constant "CXTemplateArgumentKind_NullPtr" int64_t;
      CXTemplateArgumentKind_Integral, constant "CXTemplateArgumentKind_Integral" int64_t;
      CXTemplateArgumentKind_Template, constant "CXTemplateArgumentKind_Template" int64_t;
      CXTemplateArgumentKind_TemplateExpansion, constant "CXTemplateArgumentKind_TemplateExpansion" int64_t;
      CXTemplateArgumentKind_Expression, constant "CXTemplateArgumentKind_Expression" int64_t;
    ...
    let t : t typ = enum "CXTemplateArgumentKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTypeNullabilityKind = struct
    ...
    let mapping = [
      ...
      CXTypeNullability_NullableResult, constant "CXTypeNullability_NullableResult" int64_t;
    ]
    let t : t typ = enum "CXTypeNullabilityKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTypeLayoutError = struct
    ...
    let mapping = [
      ...
      CXTypeLayoutError_NotConstantSize, constant "CXTypeLayoutError_NotConstantSize" int64_t;
      CXTypeLayoutError_InvalidFieldName, constant "CXTypeLayoutError_InvalidFieldName" int64_t;
      CXTypeLayoutError_Undeduced, constant "CXTypeLayoutError_Undeduced" int64_t;
    ]
    let t : t typ = enum "CXTypeLayoutError" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXRefQualifierKind = struct
    ...
    let t : t typ = enum "CXRefQualifierKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CX_CXXAccessSpecifier = struct
    ...
    let t : t typ = enum "CX_CXXAccessSpecifier" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CX_StorageClass = struct
    ...
    let t : t typ = enum "CX_StorageClass" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CX_BinaryOperatorKind = struct
    ...
    let t : t typ = enum "CX_BinaryOperatorKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXChildVisitResult = struct
    ...
    let t : t typ = enum "CXChildVisitResult" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end

  module CXCursorVisitor = struct
    type t = CXCursor.t structure ptr -> CXCursor.t structure ptr -> CXClientData.t -> CXChildVisitResult.t
    let t : t static_funptr typ = typedef (static_funptr (ptr (const CXCursor.t) @-> ptr (const CXCursor.t) @-> CXClientData.t @-> returning CXChildVisitResult.t)) "CXCursorVisitor"
  end
  ...
  module CXPrintingPolicyProperty = struct
    ...
    let mapping = [
      ...
      CXPrintingPolicy_SuppressSpecifiers, constant "CXPrintingPolicy_SuppressSpecifiers" int64_t;
      CXPrintingPolicy_SuppressTagKeyword, constant "CXPrintingPolicy_SuppressTagKeyword" int64_t;
      CXPrintingPolicy_IncludeTagDefinition, constant "CXPrintingPolicy_IncludeTagDefinition" int64_t;
      CXPrintingPolicy_SuppressScope, constant "CXPrintingPolicy_SuppressScope" int64_t;
      CXPrintingPolicy_SuppressUnwrittenScope, constant "CXPrintingPolicy_SuppressUnwrittenScope" int64_t;
      CXPrintingPolicy_SuppressInitializers, constant "CXPrintingPolicy_SuppressInitializers" int64_t;
      CXPrintingPolicy_ConstantArraySizeAsWritten, constant "CXPrintingPolicy_ConstantArraySizeAsWritten" int64_t;
      CXPrintingPolicy_AnonymousTagLocations, constant "CXPrintingPolicy_AnonymousTagLocations" int64_t;
      CXPrintingPolicy_SuppressStrongLifetime, constant "CXPrintingPolicy_SuppressStrongLifetime" int64_t;
      CXPrintingPolicy_SuppressLifetimeQualifiers, constant "CXPrintingPolicy_SuppressLifetimeQualifiers" int64_t;
      CXPrintingPolicy_SuppressTemplateArgsInCXXConstructors, constant "CXPrintingPolicy_SuppressTemplateArgsInCXXConstructors" int64_t;
      ...
      CXPrintingPolicy_UnderscoreAlignof, constant "CXPrintingPolicy_UnderscoreAlignof" int64_t;
      CXPrintingPolicy_UseVoidForZeroParams, constant "CXPrintingPolicy_UseVoidForZeroParams" int64_t;
      CXPrintingPolicy_TerseOutput, constant "CXPrintingPolicy_TerseOutput" int64_t;
      CXPrintingPolicy_PolishForDeclaration, constant "CXPrintingPolicy_PolishForDeclaration" int64_t;
      ...
      CXPrintingPolicy_IncludeNewlines, constant "CXPrintingPolicy_IncludeNewlines" int64_t;
      CXPrintingPolicy_MSVCFormatting, constant "CXPrintingPolicy_MSVCFormatting" int64_t;
      CXPrintingPolicy_ConstantsAsWritten, constant "CXPrintingPolicy_ConstantsAsWritten" int64_t;
      CXPrintingPolicy_SuppressImplicitBase, constant "CXPrintingPolicy_SuppressImplicitBase" int64_t;
      CXPrintingPolicy_FullyQualifiedName, constant "CXPrintingPolicy_FullyQualifiedName" int64_t;
      CXPrintingPolicy_LastProperty, constant "CXPrintingPolicy_LastProperty" int64_t;
    ]
    let t : t typ = enum "CXPrintingPolicyProperty" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXObjCPropertyAttrKind = struct
    ...
    let mapping = [
      ...
      CXObjCPropertyAttr_unsafe_unretained, constant "CXObjCPropertyAttr_unsafe_unretained" int64_t;
      CXObjCPropertyAttr_class, constant "CXObjCPropertyAttr_class" int64_t;
    ]
    let t : t typ = enum "CXObjCPropertyAttrKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXObjCDeclQualifierKind = struct
    ...
    let t : t typ = enum "CXObjCDeclQualifierKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXNameRefFlags = struct
    ...
    let t : t typ = enum "CXNameRefFlags" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXTokenKind = struct
    ...
    let t : t typ = enum "CXTokenKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXCompletionResult = struct
    type t
    let t : t structure typ = typedef (structure "CXCompletionResult") "CXCompletionResult"
  ...
  module CXCompletionChunkKind = struct
    ...
    let mapping = [
      ...
      CXCompletionChunk_CurrentParameter, constant "CXCompletionChunk_CurrentParameter" int64_t;
      ...
      CXCompletionChunk_HorizontalSpace, constant "CXCompletionChunk_HorizontalSpace" int64_t;
      CXCompletionChunk_VerticalSpace, constant "CXCompletionChunk_VerticalSpace" int64_t;
    ]
    let t : t typ = enum "CXCompletionChunkKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end

  module CXCodeCompleteResults = struct
    type t
    let t : t structure typ = typedef (structure "CXCodeCompleteResults") "CXCodeCompleteResults"
  ...
  module CXCodeComplete_Flags = struct
    ...
    let mapping = [
      ...
      CXCodeComplete_IncludeCodePatterns, constant "CXCodeComplete_IncludeCodePatterns" int64_t;
      CXCodeComplete_IncludeBriefComments, constant "CXCodeComplete_IncludeBriefComments" int64_t;
      CXCodeComplete_SkipPreamble, constant "CXCodeComplete_SkipPreamble" int64_t;
      CXCodeComplete_IncludeCompletionsWithFixIts, constant "CXCodeComplete_IncludeCompletionsWithFixIts" int64_t;
    ]
    let t : t typ = enum "CXCodeComplete_Flags" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXCompletionContext = struct
    ...
    let mapping = [
      ...
      CXCompletionContext_ObjCObjectValue, constant "CXCompletionContext_ObjCObjectValue" int64_t;
      CXCompletionContext_ObjCSelectorValue, constant "CXCompletionContext_ObjCSelectorValue" int64_t;
      CXCompletionContext_CXXClassTypeValue, constant "CXCompletionContext_CXXClassTypeValue" int64_t;
      CXCompletionContext_DotMemberAccess, constant "CXCompletionContext_DotMemberAccess" int64_t;
      CXCompletionContext_ArrowMemberAccess, constant "CXCompletionContext_ArrowMemberAccess" int64_t;
      CXCompletionContext_ObjCPropertyAccess, constant "CXCompletionContext_ObjCPropertyAccess" int64_t;
      ...
      CXCompletionContext_NestedNameSpecifier, constant "CXCompletionContext_NestedNameSpecifier" int64_t;
      CXCompletionContext_ObjCInterface, constant "CXCompletionContext_ObjCInterface" int64_t;
      CXCompletionContext_ObjCProtocol, constant "CXCompletionContext_ObjCProtocol" int64_t;
      CXCompletionContext_ObjCCategory, constant "CXCompletionContext_ObjCCategory" int64_t;
      CXCompletionContext_ObjCInstanceMessage, constant "CXCompletionContext_ObjCInstanceMessage" int64_t;
      CXCompletionContext_ObjCClassMessage, constant "CXCompletionContext_ObjCClassMessage" int64_t;
      CXCompletionContext_ObjCSelectorName, constant "CXCompletionContext_ObjCSelectorName" int64_t;
      CXCompletionContext_MacroName, constant "CXCompletionContext_MacroName" int64_t;
      CXCompletionContext_NaturalLanguage, constant "CXCompletionContext_NaturalLanguage" int64_t;
      CXCompletionContext_IncludedFile, constant "CXCompletionContext_IncludedFile" int64_t;
      CXCompletionContext_Unknown, constant "CXCompletionContext_Unknown" int64_t;
    ]
    let t : t typ = enum "CXCompletionContext" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXInclusionVisitor = struct
    type t = CXFile.t -> CXSourceLocation.t structure ptr -> Unsigned.uint -> CXClientData.t -> unit
    let t : t static_funptr typ = typedef (static_funptr (CXFile.t @-> ptr CXSourceLocation.t @-> uint @-> CXClientData.t @-> returning void)) "CXInclusionVisitor"
  end
  ...
  module CXEvalResultKind = struct
    ...
    let t : t typ = enum "CXEvalResultKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXVisitorResult = struct
    ...
    let t : t typ = enum "CXVisitorResult" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXCursorAndRangeVisitor = struct
    type t
    let t : t structure typ = typedef (structure "CXCursorAndRangeVisitor") "CXCursorAndRangeVisitor"
    let context = field t "context" (ptr void)
    let visit = field t "visit" (static_funptr (ptr void @-> ptr (const CXCursor.t) @-> ptr (const CXSourceRange.t) @-> returning CXVisitorResult.t))
    let () = seal t
  end
  ...
  module CXResult = struct
    ...
    let t : t typ = enum "CXResult" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIdxIncludedFileInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxIncludedFileInfo") "CXIdxIncludedFileInfo"
  ...
  module CXIdxImportedASTFileInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxImportedASTFileInfo") "CXIdxImportedASTFileInfo"
    let file = field t "file" CXFile.t
  ...
  module CXIdxEntityKind = struct
    ...
    let mapping = [
      ...
      CXIdxEntity_CXXConversionFunction, constant "CXIdxEntity_CXXConversionFunction" int64_t;
    ...
    let t : t typ = enum "CXIdxEntityKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIdxEntityLanguage = struct
    ...
    let t : t typ = enum "CXIdxEntityLanguage" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIdxEntityCXXTemplateKind = struct
    ...
    let mapping = [
      ...
      CXIdxEntity_TemplatePartialSpecialization, constant "CXIdxEntity_TemplatePartialSpecialization" int64_t;
      CXIdxEntity_TemplateSpecialization, constant "CXIdxEntity_TemplateSpecialization" int64_t;
    ]
    let t : t typ = enum "CXIdxEntityCXXTemplateKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIdxAttrKind = struct
    ...
    let t : t typ = enum "CXIdxAttrKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIdxContainerInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxContainerInfo") "CXIdxContainerInfo"
    let cursor = field t "cursor" CXCursor.t
    let () = seal t
  end
  ...
  module CXIdxIBOutletCollectionAttrInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxIBOutletCollectionAttrInfo") "CXIdxIBOutletCollectionAttrInfo"
  ...
  module CXIdxDeclInfoFlags = struct
    ...
    let mapping = [
      CXIdxDeclFlag_Skipped, constant "CXIdxDeclFlag_Skipped" int64_t;
    ]
    let t : t typ = enum "CXIdxDeclInfoFlags" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXIdxDeclInfo = struct
    ...
    let cursor = field t "cursor" CXCursor.t
    let loc = field t "loc" CXIdxLoc.t
    let semantic_container = field t "semanticContainer" (ptr (const CXIdxContainerInfo.t))
  ...
  module CXIdxObjCContainerKind = struct
    ...
    let mapping = [
      ...
      CXIdxObjCContainer_Implementation, constant "CXIdxObjCContainer_Implementation" int64_t;
    ]
    let t : t typ = enum "CXIdxObjCContainerKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end

  module CXIdxObjCContainerDeclInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxObjCContainerDeclInfo") "CXIdxObjCContainerDeclInfo"
  ...
  module CXIdxBaseClassInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxBaseClassInfo") "CXIdxBaseClassInfo"
  ...
  module CXIdxObjCProtocolRefInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxObjCProtocolRefInfo") "CXIdxObjCProtocolRefInfo"
  ...
  module CXIdxObjCProtocolRefListInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxObjCProtocolRefListInfo") "CXIdxObjCProtocolRefListInfo"
  ...
  module CXIdxObjCInterfaceDeclInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxObjCInterfaceDeclInfo") "CXIdxObjCInterfaceDeclInfo"
    let container_info = field t "containerInfo" (ptr (const CXIdxObjCContainerDeclInfo.t))
  ...
  module CXIdxObjCCategoryDeclInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxObjCCategoryDeclInfo") "CXIdxObjCCategoryDeclInfo"
    let container_info = field t "containerInfo" (ptr (const CXIdxObjCContainerDeclInfo.t))
    let objc_class = field t "objcClass" (ptr (const CXIdxEntityInfo.t))
    let class_cursor = field t "classCursor" CXCursor.t
    let class_loc = field t "classLoc" CXIdxLoc.t
  ...
  module CXIdxObjCPropertyDeclInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxObjCPropertyDeclInfo") "CXIdxObjCPropertyDeclInfo"
    let decl_info = field t "declInfo" (ptr (const CXIdxDeclInfo.t))
  ...
  module CXIdxCXXClassDeclInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxCXXClassDeclInfo") "CXIdxCXXClassDeclInfo"
    let decl_info = field t "declInfo" (ptr (const CXIdxDeclInfo.t))
  ...
  module CXIdxEntityRefKind = struct
    ...
    let t : t typ = enum "CXIdxEntityRefKind" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXSymbolRole = struct
    ...
    let t : t typ = enum "CXSymbolRole" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end

  module CXIdxEntityRefInfo = struct
    type t
    let t : t structure typ = typedef (structure "CXIdxEntityRefInfo") "CXIdxEntityRefInfo"
  ...
  module IndexerCallbacks = struct
    ...
    let abort_query = field t "abortQuery" (static_funptr (CXClientData.t @-> ptr void @-> returning int))
    let diagnostic = field t "diagnostic" (static_funptr (CXClientData.t @-> CXDiagnosticSet.t @-> ptr void @-> returning void))
    let entered_main_file = field t "enteredMainFile" (static_funptr (CXClientData.t @-> CXFile.t @-> ptr void @-> returning CXIdxClientFile.t))
    let pp_included_file = field t "ppIncludedFile" (static_funptr (CXClientData.t @-> ptr (const CXIdxIncludedFileInfo.t) @-> returning CXIdxClientFile.t))
    let imported_astfile = field t "importedASTFile" (static_funptr (CXClientData.t @-> ptr (const CXIdxImportedASTFileInfo.t) @-> returning CXIdxClientASTFile.t))
    let started_translation_unit = field t "startedTranslationUnit" (static_funptr (CXClientData.t @-> ptr void @-> returning CXIdxClientContainer.t))
    let index_declaration = field t "indexDeclaration" (static_funptr (CXClientData.t @-> ptr (const CXIdxDeclInfo.t) @-> returning void))
    let index_entity_reference = field t "indexEntityReference" (static_funptr (CXClientData.t @-> ptr (const CXIdxEntityRefInfo.t) @-> returning void))
    let () = seal t
  end
  ...
  module CXIndexOptFlags = struct
    ...
    let mapping = [
      ...
      CXIndexOpt_SuppressRedundantRefs, constant "CXIndexOpt_SuppressRedundantRefs" int64_t;
      CXIndexOpt_IndexFunctionLocalSymbols, constant "CXIndexOpt_IndexFunctionLocalSymbols" int64_t;
      CXIndexOpt_IndexImplicitTemplateInstantiations, constant "CXIndexOpt_IndexImplicitTemplateInstantiations" int64_t;
      CXIndexOpt_SuppressWarnings, constant "CXIndexOpt_SuppressWarnings" int64_t;
      CXIndexOpt_SkipParsedBodiesInSession, constant "CXIndexOpt_SkipParsedBodiesInSession" int64_t;
    ]
    let t : t typ = enum "CXIndexOptFlags" ~typedef:true mapping ~unexpected:(fun _ -> assert false)
  end

  module CXFieldVisitor = struct
    type t = CXCursor.t structure ptr -> CXClientData.t -> CXVisitorResult.t
    let t : t static_funptr typ = typedef (static_funptr (ptr (const CXCursor.t) @-> CXClientData.t @-> returning CXVisitorResult.t)) "CXFieldVisitor"
  end
  ...
  module CXBinaryOperatorKind = struct
    ...
    let t : t typ = enum "CXBinaryOperatorKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXUnaryOperatorKind = struct
    ...
    let t : t typ = enum "CXUnaryOperatorKind" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
  ...
  module CXErrorCode = struct
    ...
    let t : t typ = enum "CXErrorCode" ~typedef:false mapping ~unexpected:(fun _ -> assert false)
  end
